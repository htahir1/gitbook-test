...
For further depth, there is an [advanced metadata logging guide](../../how-to/track-metrics-metadata/) that goes more into detail about logging metadata in ZenML.
