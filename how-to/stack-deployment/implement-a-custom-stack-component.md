...
{% hint style="info" %}
If you would like to automatically track some metadata about your custom stack component with each pipeline run, you can do so by defining some additional methods in your stack component implementation class as shown in the [Tracking Custom Stack Component Metadata](../track-metrics-metadata/fetch-metadata-within-steps.md) section.
{% endhint %}
...
| --------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| [Orchestrator](../../stack-components/orchestrators/custom.md)              | Orchestrating the runs of your pipeline                           |
| [Artifact Store](../../stack-components/artifact-stores/custom.md)          | Storage for the artifacts created by your pipelines               |
| [Container Registry](../../stack-components/container-registries/custom.md) | Store for your containers                                         |
| [Step Operator](../../stack-components/step-operators/custom.md)            | Execution of individual steps in specialized runtime environments |
| [Model Deployer](../../stack-components/model-deployers/custom.md)          | Services/platforms responsible for online model serving           |
| [Feature Store](../../stack-components/feature-stores/custom.md)            | Management of your data/features                                  |
| [Experiment Tracker](../../stack-components/experiment-trackers/custom.md)  | Tracking your ML experiments                                      |
| [Alerter](../../stack-components/alerters/custom.md)                        | Sending alerts through specified channels                         |
| [Annotator](../../stack-components/annotators/custom.md)                    | Annotating and labeling data                                      |
| [Data Validator](../../stack-components/data-validators/custom.md)          | Validating and monitoring your data                               |
