...
{% hint style="info" %}
If you're only calling each step once inside your pipeline, the **invocation ID** will be the same as the name of your step. For more complex pipelines, check out [this page](using-a-custom-step-invocation-id.md) to learn more about the invocation ID.
{% endhint %}
...
See the [`StepRunResponse`](https://github.com/zenml-io/zenml/blob/main/src/zenml/models/v2/core/step\_run.py) definition for a comprehensive list of available information.
