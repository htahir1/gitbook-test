...
{% hint style="info" %}
Head on over to our [docs](../../stack-components/artifact-stores/gcp.md) to learn more about artifact stores and how to configure them.
{% endhint %}
{% endtab %}
{% endtabs %}
...
{% hint style="info" %}
Head on over to our [docs](../../stack-components/orchestrators/vertex.md) to learn more about orchestrators and how to configure them.
{% endhint %}
{% endtab %}
{% endtabs %}
