...
{% hint style="info" %}
See the [SDK Docs](https://sdkdocs.zenml.io/latest/core\_code\_docs/core-new/#zenml.new.pipelines.pipeline\_context.PipelineContext) for more information on which attributes and methods the `PipelineContext` provides.
{% endhint %}
