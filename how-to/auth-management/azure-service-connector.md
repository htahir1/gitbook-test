...
The [Azure Artifact Store Stack Component](../../stack-components/artifact-stores/azure.md) can be connected to a remote Azure blob storage container through an Azure Service Connector.
...
* a [Kubernetes Orchestrator](../../stack-components/orchestrators/kubernetes.md) connected to an AKS Kubernetes cluster
* a [Azure Blob Storage Artifact Store](../../stack-components/artifact-stores/azure.md) connected to an Azure blob storage container
* an [Azure Container Registry](../../stack-components/container-registries/azure.md) connected to an ACR container registry
