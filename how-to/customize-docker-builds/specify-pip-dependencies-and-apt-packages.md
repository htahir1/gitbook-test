...
*   Specify a requirements file:
    ...
    def my_pipeline(...):
        ...
    ```
* Specify a list of [ZenML integrations](../../stack-components/component-guide.md) that you're using in your pipeline:
