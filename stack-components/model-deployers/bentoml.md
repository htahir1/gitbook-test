...
For more information and a full list of configurable attributes of the BentoML Model Deployer, check out the [SDK Docs](https://sdkdocs.zenml.io/latest/integration\_code\_docs/integrations-bentoml/#zenml.integrations.bentoml.model\_deployers.bentoml\_model\_deployer) .
