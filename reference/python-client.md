...
* **Flavors**: The [stack component flavors](../getting-started/core-concepts.md#flavor) available to you, including:
  * Built-in flavors like the [local orchestrator](../stack-components/orchestrators/local.md),
  * Integration-enabled flavors like the [Kubeflow orchestrator](../stack-components/orchestrators/kubeflow.md),
